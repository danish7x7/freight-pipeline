...
_INSTRUCTIONS = (
    ...
    "accessorials (a JSON array naming any of these accessorial TYPES the email "
    "requests: detention, liftgate, appointment, chassis — types ONLY, never a price "
    "or dollar amount; omit or use [] if none), "
